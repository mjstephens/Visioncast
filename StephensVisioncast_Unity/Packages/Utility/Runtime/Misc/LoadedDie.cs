...
namespace Stephens.Utility
{
    public class LoadedDie
    {
        //      HOW TO USE:
        /*
	        // list of probabilities for each number:
	        // 0 is 150, 1 is 40, and so on

	        var loadedDie = new LoadedDie (new int [] {150, 40, 15, 3}); 


	        // return a number from 0-3 according to given probabilities;
	 ...
	 */
        ...
        // minus 1.
        public int NextValue (System.Random random)
        {
