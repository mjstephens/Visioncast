...
namespace Stephens.Utility
{
    public static class ColliderUtility
    {
        ...
        /// <returns></returns>
        public static Vector3[] GetColliderBoundsFaces(Collider col, float offset, Vector3[] facePoints)
        {
        ...
        public static Vector3[] GetBoxColliderExtentsFaces(BoxCollider col, float offset, Vector3[] facePoints)
        {
        ...
        public static Vector3[] GetBoxColliderExtentsCorners(BoxCollider col, float offset, Vector3[] cornerPoints)
        {
            Transform colTrans = col.transform;
            Vector3 center = col.center + colTrans.position;
            Vector3 size = col.size;
